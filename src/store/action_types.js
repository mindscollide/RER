...
export const GET_ALL_CITY_BRANCH_SHIFT_SERVICES_SUCCESS =
  "GET_ALL_CITY_BRANCH_SHIFT_SERVICES_SUCCESS";

export const GET_ALL_CITY_BRANCH_SHIFT_SERVICES_FAIL =
  "GET_ALL_CITY_BRANCH_SHIFT_SERVICES_FAIL";

// get All City Branch Shift Counter Services in Counter Page in Global Admin
export const GET_ALL_CITY_BRANCH_SHIFT_COUNTER_SERVICE_SUCCESS =
  "GET_ALL_CITY_BRANCH_SHIFT_COUNTER_SERVICE_SUCCESS";

export const GET_ALL_CITY_BRANCH_SHIFT_COUNTER_SERVICE_FAIL =
  "GET_ALL_CITY_BRANCH_SHIFT_COUNTER_SERVICE_FAIL";

export const GET_SERVICE_WISE_COUNTRY_SUCCESS =
  "GET_SERVICE_WISE_COUNTRY_SUCCESS";
export const GET_SERVICE_WISE_COUNTRY_FAIL = "GET_SERVICE_WISE_COUNTRY_FAIL";

export const UPDATE_SERVICE_COUNTRY_LIST_SUCCESS =
  "UPDATE_SERVICE_COUNTRY_LIST_SUCCESS";
export const UPDATE_SERVICE_COUNTRY_LIST_FAIL =
  "UPDATE_SERVICE_COUNTRY_LIST_FAIL";
